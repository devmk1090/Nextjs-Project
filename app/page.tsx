...
export const metadata: Metadata = {
  title: "계산기 모음 - 만 나이, 띠, 별자리, 디데이, 요일, 기념일, 근무일수, BMI, 음력/양력 변환",
  description: "만 나이 계산기, 띠 계산기, 별자리 계산기, 디데이 계산기, 요일 계산기, 기념일 계산기, 근무일수 계산기, BMI 계산기, 음력/양력 변환기를 한 곳에서 무료로 이용하세요. 2023년 만 나이 통일법 적용, 십이지 띠 궁합, 12 별자리 정보, D-day 계산, 요일 확인, 기념일 자동 계산, 재직기간 및 연차 계산, 체질량지수 및 표준체중, 한국 전통 명절 음력 날짜 확인까지 모든 계산 서비스를 제공합니다.",
  keywords: ["만 나이 계산기", "띠 계산기", "별자리 계산기", "디데이 계산기", "요일 계산기", "기념일 계산기", "근무일수 계산기", "연차 계산기", "재직기간 계산기", "퇴직금 계산기", "BMI 계산기", "체질량지수", "표준체중", "비만도", "음력 계산기", "양력 계산기", "계산기", "한국 나이", "십이지", "음력 변환", "양력 변환", "D-day", "100일", "200일", "무료 계산기"],
  openGraph: {
    title: "계산기 모음 - 만 나이, 띠, 별자리, 디데이, 요일, 기념일, 근무일수, BMI, 음력/양력 변환",
    description: "만 나이, 띠, 별자리, 디데이, 요일, 기념일, 근무일수, BMI, 음력/양력 변환 등 모든 계산 서비스 무료 제공",
    type: "website",
  },
};
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-100 to-purple-100 p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-4xl">
        ...
        <p className="text-gray-700 text-center mb-8 leading-relaxed">
          만 나이, 띠, 별자리, 디데이, 요일, 기념일, 근무일수, BMI, 음력/양력 변환까지 다양한 계산기를 무료로 이용하세요.
          생년월일이나 날짜, 키와 몸무게만 입력하면 정확한 결과를 바로 확인할 수 있습니다.
        </p>
